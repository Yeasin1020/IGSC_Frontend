...
type Accent = "indigo" | "violet" | "emerald" | "amber" | "rose" | "cyan";
...
> = {
  indigo: {
    icon: "bg-indigo-100 text-indigo-600 dark:bg-indigo-950/60 dark:text-indigo-300",
...
const AdminStatCard = ({
  ...
  return (
    <Link
      to={to}
      className={`group relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md sm:p-5 dark:border-gray-800 dark:bg-gray-900 ${colors.ring}`}
    >
      <div
